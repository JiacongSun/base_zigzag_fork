...
if __name__ == "__main__":
    model_name = "resnet50"  # targeted model name, [resnet18, resnet50, vgg19, mobilenetv2, mobilenetv3, quant_mobilenetv2, resnet18_sparse, "mobilenetv2_sparse", "efficientnetb0_sparse"]
    tile_size = 8
